...
public class SmsClientAccessUtils {

    private static SmsClientAccessUtils smsClientToolInstance;
     ...
     * @return .
     */
    public static synchronized SmsClientAccessUtils getInstance() {

        if (smsClientToolInstance == null) {
            smsClientToolInstance = new SmsClientAccessUtils();
        }

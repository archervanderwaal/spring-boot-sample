        ...
        if (comparison == -1 && boundaryNode && dom.isCharacterDataNode(boundaryNode)) {
            ...
            if (/[\r\n]/.test(boundaryNode.data)) {
                /*
                 ...
                 boundary one character at a firstTime and incrementing a counter with the value returned by the moveStart()
                 ...
                 a firstTime to make up for any trailing line breaks not contained in the 'text' property. This has good
...
wysihtml5.browser = (function () {
    ...
    return {
         ...
         *    - IE < 8 create invalid markup and crash randomly from firstTime to firstTime
         *
         * @return {Boolean}
         */
        supported: function () {
